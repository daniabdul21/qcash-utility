...
var AuthService = function (baseURL, token) {
    ...
    var CreateSignature = function (params) {
        ...
        var hash = crypto_js_1.default.HmacSHA256(data, secret);
    ...
    var validateToken = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 4]);
                    return [4 /*yield*/, custom_axios_1.default.get("/auth/me")];
                case 1:
                    response = _a.sent();
    ...
    var validateMenu = function (token) { return __awaiter(void 0, void 0, void 0, function () {
        var response, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 4]);
                    return [4 /*yield*/, custom_axios_1.default.post("/menu/me", { token: token })];
                case 1:
                    response = _a.sent();
    ...
    var verifyUserQuestion = function (_a) { return __awaiter(void 0, void 0, void 0, function () {
        var prepareData, response, error_7;
        var payload = __rest(_a, []);
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
    ...
    var verifyChangePasswordToken = function (_a) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, custom_axios_1.default.post("/auth/verify-change-password-token", __assign({}, payload))];
                case 1:
                    response = _b.sent();
                    return [2 /*return*/, response];
                case 2:
    ...
    var ssoLoginQlola = function (request) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, custom_axios_1.default.post("/auth/login/init-token", { request: request })];
                case 1:
                    response = _b.sent();
                    if (response.status !== 200) {
    ...
    var logoutSSO = function (clientName) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, custom_axios_1.default.get("sso/signout/".concat(clientName))];
                case 1:
                    response = _a.sent();
                    if (response.status !== 200) {
                        return [2 /*return*/];
    ...
    var login = function (branchCode, username, password) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, custom_axios_1.default.post("auth/v2/login", data, {
